...
// import { AUDIT_VIEWER_ROLE } from './authentication/roles'
...
export default function createApp(userService: UserService): express.Application {
  ...
  app.locals.applicationName = 'HMPPS Audit'
  ...
  // to protect allplication with role uncomment this line and two imports
  // and add role within hmpps-auth
  // app.use(authorisationMiddleware([AUDIT_VIEWER_ROLE]))
